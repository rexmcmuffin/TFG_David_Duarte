...
\lstset{%
  ...
  stepnumber=1,              % Cada línea será numerada
  breaklines=true            % Divide las líneas largas automáticamente
}

\lstdefinestyle{terminal}{
    backgroundcolor=\color{bgcolor}, % color de fondo
    basicstyle=\ttfamily\color{codecolor}, % estilo de fuente
    columns=fullflexible,
    keepspaces=true,
    escapeinside={(*@}{@*)}, % para insertar LaTeX dentro del código
}
