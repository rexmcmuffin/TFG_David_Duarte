...
% Please add the following required packages to your document preamble:
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{DAE8FC}Coste Económico} & \multicolumn{1}{c|}{\cellcolor[HTML]{CBCEFB}3} & \multicolumn{1}{c|}{-1} & \multicolumn{1}{c|}{+1} & \multicolumn{1}{c|}{=} \\ \hline
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{DAE8FC}Suma General} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{4} & \multicolumn{1}{c|}{36} & \multicolumn{1}{c|}{-8} \\ \cline{1-1} \cline{3-5} 
...
\begin{table}[ht]
  ...
  \begin{tabular}{|c|l|l|l|}
    ...
    \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}} 1.Investigar acerca de \\ plataformas que \\ garantizen que el análisis \\ de los datos \\ se dé en tiempo real.\end{tabular}} & \begin{tabular}[c]{@{}l@{}}1.1 Investigar sobre \\ sistemas en tiempo \\ real.\end{tabular}                                    & 5            &              \\ \cline{2-4}
    ...
    \multicolumn{1}{|l|}{}                                                                                                                                                    & \begin{tabular}[c]{@{}l@{}}2.2 Evaluación de los \\ parametros seleccionados\\  en el sistema.\end{tabular}                    & 8             & 2.1          \\ \cline{2-4}
    ...
    \multicolumn{1}{|l|}{}                                                                                                                                                    & \begin{tabular}[c]{@{}l@{}}3.2 Evaluación del \\ desempeño del sistema \\ mediante las métricas \\ seleccionadas.\end{tabular} & 5            & 3.2          \\ \cline{2-4}
    \multicolumn{1}{|l|}{}                                                                                                                                                    & \begin{tabular}[c]{@{}l@{}}3.3 Documentación de los datos. \end{tabular} & 5            & 3.1          \\ \hline    
  \end{tabular}
\end{table}
...
\begin{table}[ht]
  ...
  \begin{tabular}{|l|l|l|}
    ...
    Específico 3     & \begin{tabular}[c]{@{}l@{}}Métricas de calidad en donde \\ se define cual confuiguración \\ es mejor según la métrica \\ seleccionada.\end{tabular}                       &   21/5/2024      \\ \hline
