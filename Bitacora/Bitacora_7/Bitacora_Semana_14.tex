...
\begin{center}
	...
	\par\vspace{8mm}
	{\Large\bf\color{tecAzul}{Bitácora de Trabajo - Entrega 8}}
	\par\vspace{100mm}
...
\bf{Fecha de trabajo:} 18/10/2024.\\
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|}
        ...
        \hline
        -Implementación del caso de estudio IMU en la tarjeta de desarrollo. \\ \hline

        -Construcción del caso de estudio PID.\\ \hline

        -Análisis de resultados sobre la implementación del caso de uso IMU. \\\hline

        -Comienzo de implementación del caso de estudio PID para la tarjeta de desarrollo seleccionada\\\hline
