...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|}
        ...
        \hline
        -Implementación del caso de estudio PID en la tarjeta de desarrollo. \\ \hline

        -Análisis de resultados sobre la implementación del caso de estudio PID. \\\hline

        -Avance en el trabajo escrito en cuanto al capitulo 5 (CASOS DE USO IMU Y PID)\\\hline

        -Avance en el trabajo escrito (AGREGAR DATOS EN MARCO TEORICO RESPECTO A IMU Y PID)\\\hline
    \end{tabular}}
\end{table}
