...
\begin{table}[h!]
    ...
    \begin{figure}[h!]
      ...
      \begin{table}[h!]
          ...
          \multicolumn{1}{|c|}{Reporte de   actividades} \\ \hline
          \hline
          - Se agrega el nombre del software propietario a utilizar a la Alternativa 1: MATLAB y Simulink.\\ \hline\hline
          \multicolumn{1}{|c|}{Productos obtenidos}                            \\ \hline\hline
          Se especifica para la Alternativa 1 el software a utilizar con el fin de delimitar la solución a un marco de trabajo.\\ \hline
          \end{tabular}%
          }
          \end{table}
